...
public class CancelRequest extends javax.swing.JFrame {
    ...
    public CancelRequest(String name, int id,String userType,Connection con) {
       initComponents();
    ...
    private void initComponents() {
        ...
        jtxtRemarks.setBackground(new java.awt.Color(102, 255, 204));
        jtxtRemarks.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jtxtRemarks.setForeground(new java.awt.Color(0, 0, 255));

        jlblRemarks.setFont(new java.awt.Font("Times New Roman", 1, 20)); // NOI18N
        jlblRemarks.setForeground(new java.awt.Color(153, 153, 255));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jlblRemarks)
                .addGap(39, 39, 39)
                .addComponent(jtxtRemarks, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(52, 52, 52)
  ...
  private void checkUserType(String name, int id,String userType){
    ...
    private void jbtnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnConfirmActionPerformed
        ...
        String Reciving ="Cancelled";
        String Remarks="";
        if(jtxtRemarks.getText().equals("")){
            Remarks="Problem";
        }else{
            Remarks = jtxtRemarks.getText();
        }
         String sql = "insert into ProblemVendorProductTable (tracking_id,Prod_Id,Prod_Name,Description,Costprice,RetailPrice,Qty,Quality,vehicleno,Reciving,Remarks)values(?,?,?,?,?,?,?,?,?,?,?)";
        try {
                pst = con.prepareStatement(sql);
                ...
                if(0<count){
                    String query = "delete from TransferTable where tracking_id=?;";
