...
import Log.Login;
import Process.InsertProduct;
import Process.VendorTransfers;
...
public class Vendor extends javax.swing.JFrame {
    ...
    public Vendor(String name, int id,String userType,Connection con) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jbtnRequest.setText("Insert Product");
        ...
        jbtnTransfer.setText("Request GRN");
        ...
        jbtnRequest1.setText("View Product");
    ...
    private void jbtnRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnRequestActionPerformed
        System.gc();
        this.setVisible(false);
        new InsertProduct(name,id,userType,con).setVisible(true);
    ...
    private void jbtnTransferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnTransferActionPerformed
        System.gc();
        this.setVisible(false);
        new VendorTransfers(name,id,userType,con).setVisible(true);
